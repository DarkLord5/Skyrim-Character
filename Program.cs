...
namespace SkyrimPlayer
{
    class Program
    {
        ...
        {
            { 1, "Так как ты наркоман ебанный, ты обязан принимать 1 дозу скумы раз в два дня." },
            { 2, "Как видишь, браток, ты очередной алкаш с падика. Теперь ты обязан жрать две доп бутылки после принятия пищи." },
